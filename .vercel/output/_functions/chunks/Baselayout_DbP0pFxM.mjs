import { e as createComponent, r as renderTemplate, l as renderScript, p as renderSlot, g as addAttribute, q as renderTransition, k as renderComponent, v as createTransitionScope, w as renderHead, h as createAstro, o as Fragment } from './astro/server_DzJdx5CC.mjs';
import 'piccolore';
/* empty css                         */
...
const $$Baselayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="fr" data-astro-cid-ugyyqijz> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="view-transition" content="same-origin"><title>', '</title><script defer src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js"></script>', '</head> <body class="bg-stone-50 text-stone-900 font-sans min-h-screen flex flex-col" data-astro-cid-ugyyqijz> <div class="relative h-[10vh] overflow-hidden mt-14" data-astro-cid-ugyyqijz', `> <img class="w-full h-full object-cover object-[100%_50%]" src="/pexels-thiago-jose-amaral-3362454-6274899.jpg" data-astro-cid-ugyyqijz> <div class="absolute inset-0 flex items-center" data-astro-cid-ugyyqijz> <div class="w-full h-full flex items-center justify-center bg-[rgba(225,113,0,0.2)]" data-astro-cid-ugyyqijz> <div class="max-w-6xl mx-auto px-4 w-full" data-astro-cid-ugyyqijz> <h1 class="text-white text-lg sm:text-2xl md:text-3xl font-bold drop-shadow-lg tracking-wide" data-astro-cid-ugyyqijz>
Genealogia
</h1> <h2 class="text-white text-sm sm:text-base md:text-xl italic drop-shadow-lg tracking-wide" data-astro-cid-ugyyqijz>
Site familial d'informations généalogiques
</h2> </div> </div> </div> </div> <!-- HEADER --> <header class="bg-white border-b border-stone-200 fixed top-0 left-0 right-0 z-50 h-14 pr-[var(--scrollbar-width)]" data-astro-cid-ugyyqijz> <div class="max-w-6xl mx-auto px-4 h-full flex items-center justify-between gap-4" data-astro-cid-ugyyqijz> <!-- Logo --> <a href="/" class="flex items-center gap-2 shrink-0" data-astro-cid-ugyyqijz> <div class="w-7 h-7 rounded-lg bg-amber-100 flex items-center justify-center" data-astro-cid-ugyyqijz> <svg class="w-4 h-4 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-ugyyqijz> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197" data-astro-cid-ugyyqijz></path> </svg> </div> <span class="font-semibold text-stone-800 text-sm" data-astro-cid-ugyyqijz>Genealogia</span> </a> <!-- Nav desktop --> <nav id="desktopNav" class="hidden lg:flex items-center gap-0.5 flex-1 px-4" data-astro-cid-ugyyqijz> `, ' </nav> <!-- Actions droite --> <div class="hidden lg:flex items-center gap-2 shrink-0" data-astro-cid-ugyyqijz> ', ' </div> <!-- Burger mobile --> <button id="burger" aria-label="Menu" class="lg:hidden flex flex-col justify-center gap-1.5 p-2 rounded-lg hover:bg-stone-100 transition-colors" data-astro-cid-ugyyqijz> <span class="block w-5 h-0.5 bg-stone-600 rounded transition-all duration-200" id="b1" data-astro-cid-ugyyqijz></span> <span class="block w-5 h-0.5 bg-stone-600 rounded transition-all duration-200" id="b2" data-astro-cid-ugyyqijz></span> <span class="block w-5 h-0.5 bg-stone-600 rounded transition-all duration-200" id="b3" data-astro-cid-ugyyqijz></span> </button> </div> </header> <!-- Mobile menu --> <div id="mobileMenu" class="hidden lg:hidden bg-white border-b border-stone-200 px-4 py-3 space-y-0.5" data-astro-cid-ugyyqijz', "> ", ' <div class="h-px bg-stone-100 my-2" data-astro-cid-ugyyqijz></div> ', ' </div> <!-- MAIN --> <main class="flex-1" data-astro-cid-ugyyqijz', "> ", ' </main> <!-- FOOTER --> <footer class="border-t border-stone-200 py-4 px-4 text-center" data-astro-cid-ugyyqijz> <p class="text-xs text-stone-400" data-astro-cid-ugyyqijz>© 2026 — Genealogia</p> </footer> ', " </body> </html>"])), title, renderHead(), addAttribute(renderTransition($$result, "xntabl5b", "", "hero-banner"), "data-astro-transition-scope"), nav.map(({ href, label }) => renderTemplate`<a${addAttribute(href, "href")} data-navlink class="px-3 py-1.5 rounded-lg text-sm text-stone-500 hover:text-stone-800 hover:bg-stone-100 transition-colors whitespace-nowrap font-medium" data-astro-cid-ugyyqijz> ${label} </a>`), user ? renderTemplate`<div class="flex items-center gap-2" data-astro-cid-ugyyqijz> <a href="/profil" class="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm text-stone-600 hover:text-stone-800 hover:bg-stone-100 transition-colors font-medium" data-astro-cid-ugyyqijz> <div class="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center" data-astro-cid-ugyyqijz> <svg class="w-3.5 h-3.5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-ugyyqijz> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-ugyyqijz></path> </svg> </div> <span class="uppercase" data-astro-cid-ugyyqijz> ${user.nom} ${user.prenom.slice(0, 1)} </span> </a> <a href="/api/auth/logout" class="px-3 py-1.5 rounded-lg text-sm text-stone-400 hover:text-red-500 hover:bg-red-50 transition-colors font-medium" data-astro-cid-ugyyqijz>
Déconnexion
...
Se connecter
</a> ${ false}` })}`, addAttribute(renderTransition($$result, "hgl55wwq", "", "main-content"), "data-astro-transition-scope"), renderSlot($$result, $$slots["default"]), renderScript($$result, "C:/lacapsule-testsperso/genealogia-astro/src/layouts/Baselayout.astro?astro&type=script&index=0&lang.ts"));
}, "C:/lacapsule-testsperso/genealogia-astro/src/layouts/Baselayout.astro", "self");
