import { e as createComponent, k as renderComponent, l as renderScript, r as renderTemplate, h as createAstro, m as maybeRenderHead, g as addAttribute } from '../chunks/astro/server_DzJdx5CC.mjs';
import 'piccolore';
...
const $$Persons = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    ...
    await db.collection("users").findOne({ _id: new ObjectId(payload.userId) });
  } catch {
  ...
  function getGeneration(year) {
    if (year < 1928) return { label: "G\xE9n\xE9ration de la guerre", color: "bg-stone-100 text-stone-500" };
    ...
    if (year < 1981) return { label: "G\xE9n\xE9ration X", color: "bg-blue-50 text-blue-600" };
    if (year < 1997) return { label: "Millenials", color: "bg-violet-50 text-violet-600" };
    if (year < 2013) return { label: "G\xE9n\xE9ration Z", color: "bg-emerald-50 text-emerald-600" };
    if (year < 2026) return { label: "G\xE9n\xE9ration Alpha", color: "bg-emerald-50 text-emerald-600" };
    return { label: "G\xE9n\xE9ration Beta", color: "bg-pink-50 text-pink-700" };
  }
