import { e as createComponent, m as maybeRenderHead, g as addAttribute, r as renderTemplate, k as renderComponent, o as Fragment, h as createAstro, l as renderScript } from '../../chunks/astro/server_DzJdx5CC.mjs';
import 'piccolore';
...
↑ parent
    ...
    if (!p.unionPairs) {
      ...
      return renderTemplate`<div class="couple-node"${addAttribute(`top:${p.y + PADDING}px;left:${p.x + PADDING}px;`, "style")} data-astro-cid-kb7hcqfw> <a${addAttribute(`/tree/${p.person._id}`, "href")}${addAttribute(["card", isRoot ? "card--root" : "", isDeceased ? "card--deceased" : ""].filter(Boolean).join(" "), "class")}${addAttribute(`width:${CARD_W}px;height:${CARD_H}px;`, "style")} data-astro-cid-kb7hcqfw> <span class="card__prenom capitalize" data-astro-cid-kb7hcqfw>${p.person.prenom}</span> <span class="card__nom capitalize" data-astro-cid-kb7hcqfw>${p.person.nom.toUpperCase()}</span> ${isDeceased && p.person.dateDeces && renderTemplate`<span class="card__date" data-astro-cid-kb7hcqfw>† ${formatDateFR(p.person.dateDeces)}</span>`} </a> ${coParent && renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-kb7hcqfw": true }, { "default": ($$result2) => renderTemplate` <div${addAttribute(`sep${isDivorced ? " sep--divorced" : ""}`, "class")} data-astro-cid-kb7hcqfw>${isDivorced ? "\u2702" : "\u2665"}</div> <a${addAttribute(`/tree/${coParent._id}`, "href")}${addAttribute(["card", "card--conjoint", isDivorced ? "card--divorced" : "", isRoot ? "card--root" : "", cpDeceased ? "card--deceased" : ""].filter(Boolean).join(" "), "class")}${addAttribute(`width:${CARD_W}px;height:${CARD_H}px;`, "style")} data-astro-cid-kb7hcqfw> <span class="card__prenom capitalize" data-astro-cid-kb7hcqfw>${coParent.prenom}</span> <span class="card__nom capitalize" data-astro-cid-kb7hcqfw>${coParent.nom.toUpperCase()}</span> ${cpDeceased && coParent.dateDeces && renderTemplate`<span class="card__date" data-astro-cid-kb7hcqfw>† ${formatDateFR(coParent.dateDeces)}</span>`} </a> ` })}`} </div>`;
    }
    return renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-kb7hcqfw": true }, { "default": ($$result2) => renderTemplate`<div class="couple-node"${addAttribute(`top:${p.y + PADDING}px;left:${p.x + PADDING}px;`, "style")} data-astro-cid-kb7hcqfw> <a${addAttribute(`/tree/${p.person._id}`, "href")}${addAttribute(["card", "card--hub", isRoot ? "card--root" : "", isDeceased ? "card--deceased" : ""].filter(Boolean).join(" "), "class")}${addAttribute(`width:${CARD_W}px;height:${CARD_H}px;`, "style")} data-astro-cid-kb7hcqfw> <span class="card__prenom capitalize" data-astro-cid-kb7hcqfw>${p.person.prenom}</span> <span class="card__nom capitalize" data-astro-cid-kb7hcqfw>${p.person.nom.toUpperCase()}</span> ${isDeceased && p.person.dateDeces && renderTemplate`<span class="card__date" data-astro-cid-kb7hcqfw>† ${formatDateFR(p.person.dateDeces)}</span>`} </a> </div> ${p.unionPairs.map(({ union, pairX, pairY }) => {
      const cp = union.coParent;
      const isDivorced = union.isDivorced;
      const cpDeceased = !!cp?.dateDeces;
      return renderTemplate`<div class="couple-node"${addAttribute(`top:${pairY + PADDING}px;left:${pairX + PADDING}px;`, "style")} data-astro-cid-kb7hcqfw> <a${addAttribute(`/tree/${p.person._id}`, "href")}${addAttribute(["card", "card--self", isDeceased ? "card--deceased" : ""].filter(Boolean).join(" "), "class")}${addAttribute(`width:${CARD_W}px;height:${CARD_H}px;`, "style")} data-astro-cid-kb7hcqfw> <span class="card__prenom capitalize" data-astro-cid-kb7hcqfw>${p.person.prenom}</span> <span class="card__nom capitalize" data-astro-cid-kb7hcqfw>${p.person.nom.toUpperCase()}</span> </a> ${cp && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-kb7hcqfw": true }, { "default": ($$result3) => renderTemplate` <div${addAttribute(`sep${isDivorced ? " sep--divorced" : ""}`, "class")} data-astro-cid-kb7hcqfw>${isDivorced ? "\u2702" : "\u2665"}</div> <a${addAttribute(`/tree/${cp._id}`, "href")}${addAttribute(["card", "card--conjoint", isDivorced ? "card--divorced" : "", cpDeceased ? "card--deceased" : ""].filter(Boolean).join(" "), "class")}${addAttribute(`width:${CARD_W}px;height:${CARD_H}px;`, "style")} data-astro-cid-kb7hcqfw> <span class="card__prenom capitalize" data-astro-cid-kb7hcqfw>${cp.prenom}</span> <span class="card__nom capitalize" data-astro-cid-kb7hcqfw>${cp.nom.toUpperCase()}</span> ${cpDeceased && cp.dateDeces && renderTemplate`<span class="card__date" data-astro-cid-kb7hcqfw>† ${formatDateFR(cp.dateDeces)}</span>`} </a> ` })}`} </div>`;
    })}` })}`;
  })} </div> </div> </div> `;
